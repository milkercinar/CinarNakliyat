    ...
    <main>
      ...
      <header className="topbar">
        <div className="site-container topbar-inner">
          ...
          <a className="nav-call" href="tel:+905469690233"><span className="signal-dot" /> SEVKİYAT HATTI <b>↗</b></a>
      ...
      <section className="contact section-pad" id="iletisim"><div className="site-container"><div className="section-heading mono"><span><i className="square" /> 004 / İLETİŞİM</span><span>KARABÜK'TEN TÜM TÜRKİYE'YE</span></div><div className="contact-content"><div><span className="contact-kicker mono">BİRLİKTE HAREKETE GEÇELİM</span><h2>YÜKÜNÜZ<br />BİZE <em>EMANET.</em></h2><p className="contact-intro">Bir sonraki ağır yük sevkiyatınızı birlikte planlayalım. Yükünüzü, rotanızı ve zamanlamanızı doğrudan ekibimizle görüşün.</p></div><div className="contact-action"><div className="contact-detail"><span className="mono">01 / SEVKİYAT & FİYAT HATTI</span><a href="tel:+905469690233">0546 969 0233 <span aria-hidden="true">↗</span></a></div><div className="contact-detail"><span className="mono">02 / ŞİRKET MERKEZİ</span><address>Fevzi Çakmak Caddesi<br />Işıthan İş Hanı No: 4/404<br />Karabük Merkez, Türkiye</address></div><a href="tel:+905469690233" className="call-button"><span>HEMEN ARAYIN</span><span className="button-arrow">↗</span></a></div></div></div></section>

      <footer className="footer"><div className="site-container"><div className="footer-top"><div><span className="footer-overline mono">1980'DEN BERİ / KARABÜK</span><a className="footer-brand" href="#baslangic">ÇINAR<span>NAKLİYAT</span></a><p className="footer-description">Ağır yükte tecrübe. Her rotada güven.</p></div><div className="footer-contact"><div><span className="mono">DOĞRUDAN İLETİŞİM</span><a href="tel:+905469690233">0546 969 0233 ↗</a></div><div><span className="mono">MERKEZ OFİS</span><address>Fevzi Çakmak Caddesi, Işıthan İş Hanı<br />No: 4/404, Karabük Merkez</address></div><a href="#baslangic" className="back-top mono">BAŞA DÖN ↑</a></div></div><div className="footer-bottom mono"><span>© {new Date().getFullYear()} ÇINAR NAKLİYAT. TÜM HAKLARI SAKLIDIR.</span><span>KARABÜK / TÜRKİYE</span><span>1980'DEN GÜNÜMÜZE</span></div></div></footer>
    </main>
  );
}
