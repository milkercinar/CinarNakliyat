  ...
  return (
    <main>
      ...
      <section className="manifesto section-pad" id="hakkimizda">
        <div className="site-container">
          ...
          <div className="manifesto-layout">
            <div className="manifesto-aside mono"><span>45+ YIL<br />SAHADA.</span><div className="vertical-line" /><span>İSTANBUL<br />TÜRKİYE</span></div>
      ...
      <section className="operation" id="operasyon">
        <div className="operation-media" role="img" aria-label="Karayolunda ilerleyen yük kamyonu"><div className="media-label mono"><span>FIELD NOTE / 01</span><span>HEAVY FREIGHT • TR</span></div><span className="media-cross" aria-hidden="true">+</span></div>
      ...
      <section className="contact section-pad" id="iletisim"><div className="site-container"><div className="section-heading mono"><span><i className="square" /> 004 / İLETİŞİM</span><span>YENİ SEVKİYAT / YENİ ROTA</span></div><div className="contact-content"><div><span className="contact-kicker mono">BİRLİKTE HAREKETE GEÇELİM</span><h2>YÜKÜNÜZ<br />BİZE <em>EMANET.</em></h2></div><div className="contact-action"><p>Bir sonraki ağır yük sevkiyatınız için doğrudan görüşelim. Yükünüzü, rotanızı ve zamanlamanızı birlikte değerlendirelim.</p><a href="tel:+905469690233" className="call-button"><span>SEVKİYAT & FİYAT HATTI<br /><strong>0546 969 0233</strong></span><span className="button-arrow">↗</span></a><span className="contact-note mono"><span className="signal-dot" /> HAT AKTİF / DOĞRUDAN ARAMA</span></div></div></div></section>

      <footer className="footer"><div className="site-container"><div className="footer-top"><a className="footer-brand" href="#baslangic">ÇINAR<span>NAKLİYAT</span></a><a href="#baslangic" className="back-top mono">BAŞA DÖN ↑</a></div><div className="footer-bottom mono"><span>© {new Date().getFullYear()} ÇINAR NAKLİYAT. 1980'DEN BERİ.</span><span>41.0082° N / 28.9784° E</span><span>AĞIR YÜKTE GÜVEN.</span></div></div></footer>
    </main>
  );
}
