    ...
    <main>
      ...
      <header className="topbar">
        <div className="site-container topbar-inner">
          ...
          <a className="nav-call" href="tel:+905469690233"><span className="signal-dot" /> 0546 969 0233 <b>↗</b></a>
      ...
      <section className="contact section-pad" id="iletisim"><div className="site-container"><div className="section-heading mono"><span><i className="square" /> 004 / İLETİŞİM</span><span>KARABÜK&apos;TEN TÜM TÜRKİYE&apos;YE</span></div><div className="contact-content"><div><span className="contact-kicker mono">SEVKİYAT & FİYAT HATTI</span><h2>YÜKÜNÜZÜ<br /><em>KONUŞALIM.</em></h2><p className="contact-intro">Yükün türünü, teslimat noktasını ve planladığınız tarihi bize iletin. Taşıma seçeneklerini doğrudan birlikte değerlendirelim.</p><a className="contact-primary" href="tel:+905469690233"><span>0546 969 0233</span><span aria-hidden="true">↗</span></a></div><div className="contact-action"><div className="contact-detail"><span className="mono">DOĞRUDAN İLETİŞİM</span><p>Sevkiyat planlaması ve fiyat görüşmesi için ekibimizi arayın.</p></div><div className="contact-detail"><span className="mono">ŞİRKET MERKEZİ</span><address>Fevzi Çakmak Caddesi<br />Işıthan İş Hanı 4/404<br />Karabük Merkez, Türkiye</address></div><a href="https://www.google.com/maps/search/?api=1&query=Fevzi+%C3%87akmak+Caddesi+I%C5%9F%C4%B1than+%C4%B0%C5%9F+Han%C4%B1+4%2F404+Karab%C3%BCk+Merkez" target="_blank" rel="noopener noreferrer" className="map-link mono">KONUMU GÖRÜNTÜLE <span aria-hidden="true">↗</span></a></div></div><footer className="footer mono"><span>© {new Date().getFullYear()} ÇINAR NAKLİYAT · KARABÜK</span><a href="#baslangic">BAŞA DÖN ↑</a></footer></div></section>
    </main>
  );
}
