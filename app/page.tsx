...
export default function Home() {
  ...
  return (
    <main>
      ...
      <section className="contact section-pad" id="iletisim"><div className="site-container"><div className="section-heading mono"><span><i className="square" /> 004 / İLETİŞİM</span><span>KARABÜK&apos;TEN TÜM TÜRKİYE&apos;YE</span></div><div className="contact-content"><div><span className="contact-kicker mono">SEVKİYAT & FİYAT HATTI</span><h2>YÜKÜNÜZÜ<br /><em>KONUŞALIM.</em></h2><p className="contact-intro">Yükün türünü, teslimat noktasını ve planladığınız tarihi bize iletin. Taşıma seçeneklerini doğrudan birlikte değerlendirelim.</p><a className="contact-primary" href="tel:+905323526514"><span>+90 532 352 6514</span><span aria-hidden="true">↗</span></a></div><div className="contact-action"><div className="contact-detail"><span className="mono">DOĞRUDAN İLETİŞİM</span><p>Sevkiyat planlaması ve fiyat görüşmesi için ekibimizi arayın.</p></div><div className="contact-detail"><span className="mono">ŞİRKET MERKEZİ</span><address>Fevzi Çakmak Caddesi<br />Işıthan İş Hanı 4/404<br />Karabük Merkez, Türkiye</address></div><a href="https://www.google.com/maps/dir/?api=1&destination=Fevzi+%C3%87akmak+Caddesi%2C+I%C5%9F%C4%B1than+%C4%B0%C5%9F+Han%C4%B1%2C+Kat+4%2C+No+404%2C+Karab%C3%BCk+Merkez%2C+Karab%C3%BCk" target="_blank" rel="noopener noreferrer" className="map-link mono" aria-label="Çınar Nakliyat şirket merkezine yol tarifi al">TAM KONUMA YOL TARİFİ <span aria-hidden="true">↗</span></a></div></div><footer className="footer mono"><span>© {new Date().getFullYear()} ÇINAR NAKLİYAT · KARABÜK</span><a href="#baslangic">BAŞA DÖN ↑</a></footer></div></section>
    </main>
  );
}
